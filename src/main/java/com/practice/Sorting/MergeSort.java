...
public class MergeSort {
     ...
     * @param lo the begin index of the array
     * @param n the end index of the array
     */
    public static void mergeSort_srt(int array[], int lo, int n) {
        ...
        // Send the array, 0 and the middle index of the array [First partition]
        mergeSort_srt(array, low, middle);

        // Send the array, the middle index + 1 and the highest index of the array [Second Partition]
        mergeSort_srt(array, middle + 1, high);

        /*
         * Merging and sorting the individual partitions
         */
         ...
         * & the lowest index of the 2nd array is less than or equal to its highest index
         */
    ...
    /**
     * Used to print the smaller array
     * @param theArray the input array to print
     * @param lo the begin index
